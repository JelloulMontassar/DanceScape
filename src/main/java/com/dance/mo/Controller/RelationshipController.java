...
public class RelationshipController {
    ...
    public ResponseEntity<Void> blockUser(@PathVariable Long senderId, @PathVariable Long receiverId) {
        User currentUser = userService.getUserById(senderId);
        User userToBlock = userService.getUserById(receiverId);
    ...
    public ResponseEntity<Void> unblockUser(@PathVariable Long senderId, @PathVariable Long receiverId) {
        User currentUser = userService.getUserById(senderId);
        User userToUnblock = userService.getUserById(receiverId);
